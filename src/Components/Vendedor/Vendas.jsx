...
function Vendas() {
  ...
  const pedidos = [
    ...
    },
    {
      ...
      cliente: "Cliente 2",
      produtos: [
        { nome: "Produto 3", quantidade: 2 },
        { nome: "Produto 8", quantidade: 4 },
      ],
      data: "00/00/0000 00:00",
    },
    {
    ...
    },
    {
      ...
      status: "finalizado",
      cliente: "Cliente 5",
      produtos: [{ nome: "Produto 2", quantidade: 2 }],
      data: "00/00/0000 00:00",
    },
    {
      id: 5,
      ...
      <div className="vertical-nav-v">
        <ul className="nav-vertical">
          <li className="nav-vertical-item">
            <button
              className={`pedidos-pendentes nav-v-item ${
          ...
          <li className="nav-vertical-item">
            <button
              className={`pedidos-em-andamento nav-v-item ${
          ...
          <li className="nav-vertical-item">
            <button
              className={`pedidos-finalizados nav-v-item ${
                activeTab === "finalizados" ? "active" : ""
              }`}
      ...
      <div className="panel-content">
        <div className="top-panel-content">
          ...
          <div className="btns-panel-content">
            ...
            >
              ...
              <span
                className={`tooltip-importar ${
                  showImportTooltip ? "visible" : ""
                }`}
              >
                Importar lista de pedidos
              </span>
            </button>
          </div>
        </div>
        <div className="pedidos-container">
          {filteredPedidos.length === 0 ? (
            <div className="no-pedidos-message">
              Ops! Ainda não há nenhum pedido por aqui...
            </div>
          ) : (
            filteredPedidos.map((pedido) => (
              <div
                key={pedido.id}
                className={`pedido-card pedido-${pedido.status}`}
              ...
              >
                ...
                <div className="btn-group">
                  {pedido.status === "pendente" && (
                    <>
                      <button
                        className="btn-confirmar-envio btn-v2"
                        onClick={handleOpenConfirmPopup}
                      >
                        Confirmar envio
                      </button>
                      <button
                        className="btn-cancelar-pedido btn-v2"
                  ...
                  {pedido.status === "em-andamento" && (
                    <span className="status-pedido-ea">Em rota de entrega</span>
                  )}
                  {pedido.status === "finalizado" && (
                    <span className="status-pedido-f">Pedido entregue</span>
                  )}
                </div>
              </div>
            ))
